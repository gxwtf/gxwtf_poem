...
const array = {
    ...
    // senior: ["芣苢","插秧歌","齐桓晋文之事","庖丁解牛","烛之武退秦师","鸿门宴","窦娥冤","与妻书","促织","皂罗袍·原来姹紫嫣红开遍","苏武传","燕歌行·并序","氓","孔雀东南飞","石钟山记","长恨歌","九歌·湘夫人","咏怀八十二首·其一","杂诗十二首·其二","越中览古","一剪梅·红藕香残玉簟秋","今别离·其一","夜归鹿门山歌","菩萨蛮·人人尽说江南好","积雨辋川庄作","旅夜书怀","新城道中·其一","阁夜","苏幕遮·燎沉香","九歌·国殇","登柳州城楼寄漳汀封连四州","菩萨蛮·小山重叠金明灭","般涉调·哨遍·高祖还乡","过小孤山大孤山","项羽之死","方山子传","大铁椎传","祭十二郎文","狱中杂记","陶庵梦忆序","春夜宴从弟桃花园序","游沙湖","苦斋记"]
    senior: ["人皆有不忍人之心"]
};
