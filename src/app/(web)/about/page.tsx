        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4 text-sm">
              <div>
                <h4 className="font-medium mb-2">开源协议</h4>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2 text-sm">
              <p><strong>网站名称：</strong>广学古诗文</p>
              <p><strong>备案号：</strong>京ICP备2025107534号-1</p>
              <p><strong>运营主体：</strong>广学五题坊技术团队</p>
              <p><strong>联系方式：</strong>gxwtf@foxmail.com</p>
            </div>
          </CardContent>
        </Card>
