    ...
    paragraph: [
      {
        ...
        "notes": [
          { "start": 0, "end": 3, "note": "南朝宋文帝刘义隆好大喜功，仓促北伐，遭到重创。元嘉，宋文帝刘义隆的年号（424—453）。草草，轻率。" },
          { "start": 5, "end": 8, "note": "汉武帝元狩四年（前119），霍去病远征匈奴，歼敌七万余，封狼居得山而还。封，登山祭天，以纪功勋。狼居，山名，即今蒙古国境内的肯特山。这里用“元嘉北伐”暗示南宋朝廷要汲取历史教训。《宋书•王玄谟传》载刘义隆对殷景仁说：“闻王玄谟陈说，使人有封狼居晉意。”" },
      ...
      },
      {
        ...
        "notes": [
          { "start": 5, "end": 7, "note": "北魏太武帝拓跋焘（408—452）小名“佛狸”。公元450年，他反击刘宋，兵锋南下，在长江北岸瓜步山上建立行宫，后称“佛狸祠”。" },
          { "start": 12, "end": 13, "note": "指在庙里吃祭品的乌鸦。" },
          { "start": 14, "end": 15, "note": "社日祭祀土地神的鼓声。南宋时期，当地老百姓只把佛狸祠当作一般祠庙来祭祀供奉，而不知道它过去曾是北魏皇帝的行宫。" },
        ]
      },
      {
        "sentence": [
        ...
        "notes": [
          { "start": 4, "end": 13, "note": "据《史记 •廉颇蔺相如列传》，战国时赵国名将廉颇被免职后跑到魏国，后来赵王想重新起用他，派人去探看他的身体状况。廉颇在使者面前吃下饭一斗、肉十斤，披甲上马，以示尚可大用。使者受廉颇仇人郭开的贿赂，回来报告赵王说：“廉将军虽老，尚善饭，然与臣坐，顷之三遗矢矣。”（矢，同“屎”。）赵王以为廉颇已老，遂不召。" }
        ]
      }
    ]
  }
